...
def main():
    ...
    paused = False
    # Display the Start Menu (with the highest score shown)
    show_start_screen(screen, font, game.high_score)

    while running:
        screen.fill((0, 0, 0))
        # Draw the background of the "Next Block" area on the right (distinguish it from the main area's color)
